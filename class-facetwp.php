<?php
/**
 * Contains all of FacetWP functionality.
 *
...
final class WPGraphQL_FacetWP {
	 ...
	 * @access public
	 */
	public static function instance() : WPGraphQL_FacetWP {
		self::$use_graphql_pagination = apply_filters( 'wpgraphql_facetwp_user_graphql_pagination', false );

		if ( ! self::$instance instanceof WPGraphQL_FacetWP ) {
	 ...
	 *
	 * @param string $type The WPGraphQL type name.
	 *
	 * @access public
	 * @since  0.0.1
	 */
	 ...
	 * @since  0.0.1
	 */
	private function register_root_field( array $config ) :void {
		$type     = $config['type'];
	 ...
	 * @since  0.0.1
	 */
	private function register_facet_connection( array $config ) : void {
		$type     = $config['type'];
		$singular = $config['singular'];
		$field    = $config['field'];
		 ...
		 * @param array $facet_data The facet data array used to generate the config.
		 */
	 ...
	 * @since  0.0.1
	 */
	private function register_output_types() : void {
	 ...
	 */
	private function register_facet_settings() : void {
	 ...
	 * @since  0.0.1
	 */
	private function register_custom_output_types( array $config ) : void {
		$singular = $config['singular'];
		$field    = $config['field'];
	 ...
	 * @since  0.0.1
	 */
	private function register_input_arg_types( array $config ) : void {
		$field = $config['field'];
...
if ( ! function_exists( 'wpgraphql_facetwp_init' ) ) {
	 ...
	 * @since 0.0.1
	 */
	function wpgraphql_facetwp_init() : WPGraphQL_FacetWP {
		/**
